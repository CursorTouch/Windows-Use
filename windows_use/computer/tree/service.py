...
from windows_use.computer.tree.cache_utils import CachedControlHelper, CacheRequestFactory
from windows_use.computer.tree.config import (
    DEFAULT_ACTIONS,
...
from windows_use.computer.tree.utils import random_point_within_bounding_box
from windows_use.computer.tree.types import (
    BoundingBox,
    Center,
    ScrollElementNode,
    TextElementNode,
...
class Tree:
                ...
                if (
                    ...
                    try:
                        ...
                        if scroll_pattern and scroll_pattern.VerticallyScrollable:
                            ...
                            metadata["horizontal_scroll_percent"] = round(
                            ...
                            metadata["vertical_scroll_percent"] = round(
            ...
            for orig_idx, child in traversal:
                ...
                # Check if the child is a dialog
                    ...
                    if not child.CachedIsOffscreen:
                        if is_dom and self.dom_bounding_box and dom_interactive_nodes is not None:
    ...
    def on_focus_change(self, sender: Any) -> None:
